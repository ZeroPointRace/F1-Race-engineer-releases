...
- 🏁 **Verseny végén automatikus visszatérés a főmenübe** (eddig a Verseny nézeten ragadt).
- 🚦 A Govee zászlófény mostantól **kilépéskor lekapcsol**.
- 🛠️ Az **ügyfélszolgálat-kapcsolat gombok javítva** (a licenc-figyelmeztetésben és a Licenc oldalon): egy kattintással elküldik a naplót a támogatásnak.
